...
function setup() {
	...
	leftBody = Bodies.rectangle(510,610,25,100);
	World.add(world, leftBody);
	leftSprite=createSprite(300,610,25,100);
	leftSprite.shapeColor="red";

	rightBody = Bodies.rectangle(510,610,25,100);
	World.add(world, rightBody);
	rightSprite=createSprite(510,610,25,100);
